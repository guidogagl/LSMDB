...
INSERT INTO `esercizio1`.`messaggio` (`id`, `mittente`, `destinatario`, `progetto`, `testo`, `stake`, `data`) 
VALUES ('1', 'Tesla', 'Ecord', '1', 'La nostra azienda avrebbe bisogno di denaro per finanziare il viaggio sulla Luna', '1000', '2019-10-18');
INSERT INTO `esercizio1`.`messaggio` (`id`, `mittente`, `destinatario`, `progetto`, `testo`, `stake`, `data`) 
VALUES ('2', 'Volkswagen', 'Ecord', '2', 'Vorremmo un finanziamento per pubblicizzare la nuova auto', '2000', '2019-10-18');
